...
- (void)setRate:(CGFloat)rate {
    ...
    CGFloat br = _backNormalRed + (_backSelectedRed - _backNormalRed) * rate;
    CGFloat bg = _backNormalGreen + (_backSelectedGreen - _backNormalGreen) * rate;
    CGFloat bb = _backNormalBlue + (_backSelectedBlue - _backNormalBlue) * rate;
    CGFloat ba = _backNormalAlpha + (_backSelectedAlpha - _backNormalAlpha) * rate;
    self.textColor = [UIColor colorWithRed:r green:g blue:b alpha:a];
    self.backgroundColor = [UIColor colorWithRed:br green:bg blue:bb alpha:ba];
...
- (void)setBackSelectedColor:(UIColor *)backSelectedColor{
    _backSelectedColor = backSelectedColor;
    [backSelectedColor getRed:&_backSelectedRed green:&_backSelectedGreen blue:&_backSelectedBlue alpha:&_backSelectedAlpha];
}

- (void)setBackNormalColor:(UIColor *)backNormalColor{
    _backNormalColor = backNormalColor;
    [backNormalColor getRed:&_backNormalRed green:&_backNormalGreen blue:&_backNormalBlue alpha:&_backNormalAlpha];
}
