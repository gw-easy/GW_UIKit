...
@property (strong, nonatomic) UIColor *backNormalColor;   ///> normal状态的背景颜色，默认为黑色 (可动画)
@property (strong, nonatomic) UIColor *backSelectedColor; ///> Selected状态的背景颜色，默认为红色 (可动画)
